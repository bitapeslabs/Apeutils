...
* @returns {any}
*/
module.exports.get_runestone_from_transaction_hex = function(hex_tx) {
    const ptr0 = passStringToWasm0(hex_tx, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_runestone_from_transaction_hex(ptr0, len0);
...
const path = require('path').join(__dirname, 'decoder_bg.wasm');
